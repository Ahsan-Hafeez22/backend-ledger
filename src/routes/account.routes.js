...
router.patch('/change-account-status/:status', authMiddleware.authMiddleware, sensitiveLimiter, accountController.changeAccountStatus);
router.get('/account', authMiddleware.authMiddleware, sensitiveLimiter, accountController.getAccount);
router.get('/balance/:accountNumber', authMiddleware.authMiddleware, sensitiveLimiter, accountController.getAccountBalance);
